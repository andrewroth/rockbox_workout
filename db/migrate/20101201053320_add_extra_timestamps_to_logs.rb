class AddExtraTimestampsToLogs < ActiveRecord::Migration
  ...
  def self.down
    ...
    remove_column :exercise_log_entries, :started_at
    remove_column :exercise_log_entries, :finished_at
    remove_column :exercise_log_entries, :last_completed_at
    remove_column :set_log_entries, :started_at
    remove_column :set_log_entries, :completed_at
    remove_column :set_log_entries, :done_rested_at
  end
end
